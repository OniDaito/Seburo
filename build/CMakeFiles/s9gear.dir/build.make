...
CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o: CMakeFiles/s9gear.dir/flags.make
CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o: ../src/gl/geometry.cpp
	...
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Building CXX object CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o"
	/usr/bin/c++   $(CXX_DEFINES) $(CXX_FLAGS) -o CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o -c /home/oni/Projects/S9Gear/src/gl/geometry.cpp

CMakeFiles/s9gear.dir/src/gl/geometry.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/s9gear.dir/src/gl/geometry.cpp.i"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -E /home/oni/Projects/S9Gear/src/gl/geometry.cpp > CMakeFiles/s9gear.dir/src/gl/geometry.cpp.i

CMakeFiles/s9gear.dir/src/gl/geometry.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/s9gear.dir/src/gl/geometry.cpp.s"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_FLAGS) -S /home/oni/Projects/S9Gear/src/gl/geometry.cpp -o CMakeFiles/s9gear.dir/src/gl/geometry.cpp.s

CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.requires:
.PHONY : CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.requires

CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.provides: CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.requires
	$(MAKE) -f CMakeFiles/s9gear.dir/build.make CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.provides.build
.PHONY : CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.provides

CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.provides.build: CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o
...
libs9gear.so: CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o
...
libs9gear.so: /usr/local/lib/libglut.so
libs9gear.so: ../lib/libassimp.so
libs9gear.so: /usr/local/lib/libglfw.so
libs9gear.so: /usr/local/lib/libAntTweakBar.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libXrandr.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/librt.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libX11.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libXext.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libXxf86vm.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libGLU.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libGL.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libSM.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libICE.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libX11.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libXext.so
...
libs9gear.so: /usr/lib/libboost_date_time-mt.so
libs9gear.so: /usr/lib/libboost_iostreams-mt.so
libs9gear.so: /usr/local/lib/libpcl_common.so
libs9gear.so: /usr/local/lib/libpcl_geometry.so
libs9gear.so: /usr/local/lib/libpcl_octree.so
libs9gear.so: /usr/lib/libOpenNI.so
libs9gear.so: /usr/local/lib/libpcl_io.so
libs9gear.so: /usr/local/lib/libpcl_sample_consensus.so
libs9gear.so: /usr/lib/libflann_cpp_s.a
libs9gear.so: /usr/local/lib/libpcl_kdtree.so
libs9gear.so: /usr/local/lib/libpcl_search.so
libs9gear.so: /usr/local/lib/libpcl_filters.so
libs9gear.so: /usr/local/lib/libpcl_segmentation.so
libs9gear.so: /usr/local/lib/libpcl_visualization.so
libs9gear.so: /usr/local/lib/libpcl_features.so
libs9gear.so: /usr/lib/libqhull.so
libs9gear.so: /usr/local/lib/libpcl_surface.so
libs9gear.so: /usr/local/lib/libpcl_registration.so
libs9gear.so: /usr/local/lib/libpcl_keypoints.so
libs9gear.so: /usr/local/lib/libpcl_tracking.so
libs9gear.so: /usr/local/lib/libpcl_apps.so
libs9gear.so: /usr/local/lib/libpcl_3d_rec_framework.so
libs9gear.so: /usr/local/lib/libpcl_recognition.so
libs9gear.so: /usr/local/lib/libpcl_ml.so
libs9gear.so: /usr/lib/libboost_filesystem-mt.so
libs9gear.so: /usr/lib/libboost_system-mt.so
libs9gear.so: /usr/lib/libboost_thread-mt.so
libs9gear.so: /usr/lib/libboost_iostreams-mt.so
...
libs9gear.so: /usr/local/lib/libpcl_recognition.so
libs9gear.so: /usr/local/lib/libpcl_ml.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libfreetype.so
libs9gear.so: /usr/lib/libgl2ps.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libGL.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libXt.so
libs9gear.so: /usr/lib/libpq.so
libs9gear.so: /usr/lib/libmysqlclient.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libpng.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libz.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libjpeg.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libtiff.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libexpat.so
libs9gear.so: /usr/lib/libavformat.so
libs9gear.so: /usr/lib/libavcodec.so
libs9gear.so: /usr/lib/libavutil.so
libs9gear.so: /usr/lib/libswscale.so
libs9gear.so: /usr/lib/openmpi/lib/libmpi.so
libs9gear.so: /usr/lib/openmpi/lib/libopen-rte.so
libs9gear.so: /usr/lib/openmpi/lib/libopen-pal.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libdl.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libnsl.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libutil.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libm.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libdl.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libnsl.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libutil.so
libs9gear.so: /usr/lib/x86_64-linux-gnu/libm.so
libs9gear.so: /usr/lib/openmpi/lib/libmpi_cxx.so
libs9gear.so: /usr/lib/libboost_signals-mt.so
libs9gear.so: /usr/lib/libboost_program_options-mt.so
...
CMakeFiles/s9gear.dir/requires: CMakeFiles/s9gear.dir/src/gl/geometry.cpp.o.requires
