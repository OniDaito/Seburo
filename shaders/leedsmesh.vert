...
layout (location = 2) in vec2 attribTexCoord1;
layout (location = 2) in vec2 attribTexCoord2;
layout (location = 2) in vec2 attribTexCoord3;
layout (location = 2) in vec2 attribTexCoord4;
layout (location = 2) in vec2 attribTexCoord5;
layout (location = 2) in vec2 attribTexCoord6;
layout (location = 2) in vec2 attribTexCoord7;


void main() {            
    vVertexNormal = vec4(-attribNormal,0.0); //normalize(uNormalMatrix * vec4(-attribNormal,1.0));
