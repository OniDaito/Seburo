        ...
        return glGetUniformLocation(p, name);
			...
			void sign( ShaderClause<glm::mat4, N> &c) {
				...
				for (int i = 0; i < N; ++i){
					...
					tp[i*16 + 1] = c.data[i][0][1];
					tp[i*16 + 2] = c.data[i][0][2];
					tp[i*16 + 3] = c.data[i][0][3];
					tp[i*16 + 4] = c.data[i][1][0];
					tp[i*16 + 5] = c.data[i][1][1];
					tp[i*16 + 6] = c.data[i][1][2];
					tp[i*16 + 7] = c.data[i][1][3];
					tp[i*16 + 8] = c.data[i][2][0];
					tp[i*16 + 9] = c.data[i][2][1];
					tp[i*16 + 10] = c.data[i][2][2];
					tp[i*16 + 11] = c.data[i][2][3];
					tp[i*16 + 12] = c.data[i][3][0];
					tp[i*16 + 13] = c.data[i][3][1];
					tp[i*16 + 14] = c.data[i][3][2];
			...
			void sign( ShaderClause<glm::mat4x2, N> &c) {
				...
				for (int i = 0; i < N; ++i){
					...
					tp[i*8 + 2] = c.data[i][1][0];
					tp[i*8 + 3] = c.data[i][1][1];
					tp[i*8 + 4] = c.data[i][2][0];
					tp[i*8 + 5] = c.data[i][2][1];
					tp[i*8 + 6] = c.data[i][3][0];
