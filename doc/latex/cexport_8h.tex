\hypertarget{cexport_8h}{\section{include/assimp/cexport.h \-File \-Reference}
\label{cexport_8h}\index{include/assimp/cexport.\-h@{include/assimp/cexport.\-h}}
}


\-Defines the \-C-\/\-A\-P\-I for the \hyperlink{namespaceAssimp}{\-Assimp} export interface.  
...
\item 
struct \hyperlink{structaiExportFormatDesc}{ai\-Export\-Format\-Desc}
\item 
struct \hyperlink{structaiExportDataBlob}{ai\-Export\-Data\-Blob}
...
\hyperlink{structaiExportFormatDesc}{ai\-Export\-Format\-Desc} $\ast$ \hyperlink{cexport_8h_adda7f2e6611f719af6c8a4a0bef0a0a2}{ai\-Get\-Export\-Format\-Description} (size\-\_\-t p\-Index)
\item 
\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I void \hyperlink{cexport_8h_a3b462a882e970cd7f492e293e5dee4fe}{ai\-Copy\-Scene} (const \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiScene}{ai\-Scene} $\ast$p\-In, \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiScene}{ai\-Scene} $\ast$$\ast$p\-Out)
\item 
\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I ai\-Return \hyperlink{cexport_8h_a9615510b8430a9da4f435a72148128dd}{ai\-Export\-Scene} (const \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiScene}{ai\-Scene} $\ast$p\-Scene, const char $\ast$p\-Format\-Id, const char $\ast$p\-File\-Name, unsigned int p\-Preprocessing)
\item 
\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I ai\-Return \hyperlink{cexport_8h_a94fe06ba0fe03e934d387f2ed6e407d2}{ai\-Export\-Scene\-Ex} (const \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiScene}{ai\-Scene} $\ast$p\-Scene, const char $\ast$p\-Format\-Id, const char $\ast$p\-File\-Name, \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiFileIO}{ai\-File\-I\-O} $\ast$p\-I\-O, unsigned int p\-Preprocessing)
\item 
\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I const \-C\-\_\-\-S\-T\-R\-U\-C\-T \*
\hyperlink{structaiExportDataBlob}{ai\-Export\-Data\-Blob} $\ast$ \hyperlink{cexport_8h_a33b02f2dbfd79980bf29e62f3a64139f}{ai\-Export\-Scene\-To\-Blob} (const \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiScene}{ai\-Scene} $\ast$p\-Scene, const char $\ast$p\-Format\-Id, unsigned int p\-Preprocessing)
\item 
\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I \-C\-\_\-\-S\-T\-R\-U\-C\-T void \hyperlink{cexport_8h_af2edbb50e352d59a4483d333c22d1d83}{ai\-Release\-Export\-Blob} (const \-C\-\_\-\-S\-T\-R\-U\-C\-T \hyperlink{structaiExportDataBlob}{ai\-Export\-Data\-Blob} $\ast$p\-Data)
\end{DoxyCompactItemize}
...
\subsubsection[{ai\-Copy\-Scene}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I void {\bf ai\-Copy\-Scene} (
...
\-Create a modifyable copy of a scene. \-This is useful to import files via \hyperlink{namespaceAssimp}{\-Assimp}, change their topology and export them again. \-Since the scene returned by the various importer functions is const, a modifyable copy is needed. 
...
\subsubsection[{ai\-Export\-Scene}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I ai\-Return {\bf ai\-Export\-Scene} (
\begin{DoxyParamCaption}
...
\subsubsection[{ai\-Export\-Scene\-Ex}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I ai\-Return {\bf ai\-Export\-Scene\-Ex} (
\begin{DoxyParamCaption}
\item[{const \-C\-\_\-\-S\-T\-R\-U\-C\-T {\bf ai\-Scene} $\ast$}]{p\-Scene, }
\item[{const char $\ast$}]{p\-Format\-Id, }
\item[{const char $\ast$}]{p\-File\-Name, }
...
\end{DoxyReturn}
\begin{DoxyNote}{\-Note}
\-Include $<$ai\-File\-I\-O.\-h$>$ for the definition of \hyperlink{structaiFileIO}{ai\-File\-I\-O}. 
\end{DoxyNote}
...
\subsubsection[{ai\-Export\-Scene\-To\-Blob}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I const \-C\-\_\-\-S\-T\-R\-U\-C\-T {\bf ai\-Export\-Data\-Blob}$\ast$ {\bf ai\-Export\-Scene\-To\-Blob} (
\begin{DoxyParamCaption}
\item[{const \-C\-\_\-\-S\-T\-R\-U\-C\-T {\bf ai\-Scene} $\ast$}]{p\-Scene, }
\item[{const char $\ast$}]{p\-Format\-Id, }
\item[{unsigned int}]{p\-Preprocessing}
...
\subsubsection[{ai\-Get\-Export\-Format\-Count}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I size\-\_\-t {\bf ai\-Get\-Export\-Format\-Count} (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}\label{cexport_8h_a59cfffbc5b436da8ed8542108102b502}
\-Returns the number of export file formats available in the current \hyperlink{namespaceAssimp}{\-Assimp} build. \-Use \hyperlink{cexport_8h_adda7f2e6611f719af6c8a4a0bef0a0a2}{ai\-Get\-Export\-Format\-Description()} to retrieve infos of a specific export format. \hypertarget{cexport_8h_adda7f2e6611f719af6c8a4a0bef0a0a2}{\index{cexport.\-h@{cexport.\-h}!ai\-Get\-Export\-Format\-Description@{ai\-Get\-Export\-Format\-Description}}
\index{ai\-Get\-Export\-Format\-Description@{ai\-Get\-Export\-Format\-Description}!cexport.h@{cexport.\-h}}
\subsubsection[{ai\-Get\-Export\-Format\-Description}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I const \-C\-\_\-\-S\-T\-R\-U\-C\-T {\bf ai\-Export\-Format\-Desc}$\ast$ {\bf ai\-Get\-Export\-Format\-Description} (
\begin{DoxyParamCaption}
...
\subsubsection[{ai\-Release\-Export\-Blob}]{\setlength{\rightskip}{0pt plus 5cm}\-A\-S\-S\-I\-M\-P\-\_\-\-A\-P\-I \-C\-\_\-\-S\-T\-R\-U\-C\-T void {\bf ai\-Release\-Export\-Blob} (
\begin{DoxyParamCaption}
